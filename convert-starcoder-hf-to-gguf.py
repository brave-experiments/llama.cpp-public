...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--ignore-eos",  action='store_true',    help="ignore EOS token when converting vocab")
...
special_vocab = gguf.SpecialVocab(dir_model, load_merges = True, ignore_eos = args.ignore_eos)
